...
use App\Models\TareasTicket;
use Illuminate\Http\Request;

class TareasTickets extends Controller
{
    /**
    ...
    {
        return response()->json(TareasTicket::all());
    }
    ...
    public function store(Request $request)
    {
        ...
        $ticket = TareasTicket::create($validated);
